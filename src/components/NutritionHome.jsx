...
import { ScreenHeader, SectionLabel, Card, HeroCard, ButtonPrimary, ButtonSecondary, ButtonText, StatTile, ListRow, Divider, EmptyState, SegmentedTabs } from "./ui/Kit.jsx";
    ...
    <div className="space-y-5">
      ...
      {!targets ? (
        ...
        <>
          ...
          <SegmentedTabs tabs={NUTRITION_TABS} value={tab} onChange={setTab} />
          ...
          {tab === "meals" && (
            <>
              {/* Meal Structure — a pure numeric split of the daily target across meals (no food
                  items), so it always reconciles exactly back to the Plan tab's target. Recommended
                  Meal Plan below is the place for concrete example foods. */}
